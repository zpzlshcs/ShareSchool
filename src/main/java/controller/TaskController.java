...
public class TaskController {
	...
	@ResponseBody
	public ResultBean<TaskCustom> insertTask(@RequestBody TaskCustom taskCustom, HttpServletRequest request)
			throws Exception {
		...
		if (taskCustom.getEnd() == null)
			throw new CustomException(101, "任务结束时间END不能为空");
		...
		taskCustom.setTaskEndtime(format.parse(taskCustom.getEnd()));
	...
	@ResponseBody
	public ResultBean<TaskCustom> changeTask(@RequestBody TaskCustom taskCustom, HttpServletRequest request)
			throws Exception {
		if (taskCustom.getUserId() == null)
			throw new CustomException(101, "用户userId不能为空");
		CheckToken.check(request, taskCustom.getUserId());
		...
		return taskService.update(taskCustom);
	}

	@RequestMapping(value = "/deleteTask", method = RequestMethod.POST)
	@ResponseBody
	public ResultBean<TaskCustom> deleteTask(@RequestBody TaskCustom taskCustom, HttpServletRequest request)
			throws Exception {
		if (taskCustom.getUserId() == null)
			throw new CustomException(101, "用户userId不能为空");
		CheckToken.check(request, taskCustom.getUserId());
	...
	@ResponseBody
	public ResultBean<TaskCustom> getTask(HttpServletRequest request) throws Exception {
	...
	@ResponseBody
	public ResultBean<ResultList<TaskCustom>> getList(HttpServletRequest request) throws Exception {
		Map<String, String> map = RequestUtil.RequestToMap(request);
		TaskCustom task = new TaskCustom();
		Integer pageSize = 10;
		Integer pageNum = 1;
		if (map.containsKey("userId")) {
			task.setUserId(Integer.valueOf(map.get("userId")));
			CheckToken.check(request, Integer.valueOf(map.get("userId")));
		}
	...
	@ResponseBody
	public ResultBean<ResultList<TaskCustom>> getListByTime(HttpServletRequest request) throws Exception {
		...
		return taskService.getTaskListSelectiveByTime(task, startTime, endTime, pageSize, pageNum);
	}

	@RequestMapping(value = "/Task/getTask",method = RequestMethod.GET)
	@ResponseBody
	public ResultBean<TaskCustom> TaskgetTask(HttpServletRequest request) throws Exception {
	...
	@ResponseBody
	public ResultBean<ResultList<TaskCustom>> TaskgetList(HttpServletRequest request) throws Exception {
		CheckToken.checkManager(request);
		Map<String, String> map = RequestUtil.RequestToMap(request);
		TaskCustom task = new TaskCustom();
		Integer pageSize = 10;
	...
	@RequestMapping(value = "/Task/getListByTime",method = RequestMethod.GET)
	@ResponseBody
	public ResultBean<ResultList<TaskCustom>> TaskgetListByTime(HttpServletRequest request) throws Exception {
		CheckToken.checkManager(request);
		Map<String, String> map = RequestUtil.RequestToMap(request);
		TaskCustom task = new TaskCustom();
		Date startTime = null;
